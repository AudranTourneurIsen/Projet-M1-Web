  ...
  <main className="flex min-h-screen flex-col items-center justify-between p-24">
    <div className="container h-full mx-auto flex justify-center items-center m-4">
      <div className="space-y-2 text-center">
        <h1 className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-700 to-purple-400 glitch">
          The Great Library
        </h1>
        <h2 className="dark:text-gray-200 text-xl">
